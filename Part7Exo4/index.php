...
// supression du cookie au clic de déconnection
...
// attribut d'une variable si le cooki existe
if(!empty($_COOKIE ['userInfo'])){
    $userInformations = $_COOKIE['userInfo'];
}

// si le cooki n'existe pas, création à partir d'un tableau
if (!empty ($_POST['email']) && !empty ($_POST['password'])){
$user = [
    'email' => $_POST['email'],
    'password' => $_POST['password'],
];
setcookie('userInfo', serialize($user));
...
<p>infos cookie : <?= $userInformations?></p> <?php
else : ?>
